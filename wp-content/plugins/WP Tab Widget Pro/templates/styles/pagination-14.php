...
?>
<style type="text/css">
#<?php echo $widget_id; ?>_content.wptp-pagination-style-14.wptp_widget_content .wptp-pagination li .page-numbers {
...
#<?php echo $widget_id; ?>_content.wptp-pagination-style-14.wptp_widget_content .wptp-pagination li .page-numbers.prev,
#<?php echo $widget_id; ?>_content.wptp-pagination-style-14.wptp_widget_content .wptp-pagination li .page-numbers.next {
...
#<?php echo $widget_id; ?>_content.wptp-pagination-style-14.wptp_widget_content .wptp-pagination li a.page-numbers:hover {
...
#<?php echo $widget_id; ?>_content.wptp-pagination-style-14.wptp_widget_content .wptp-pagination li .page-numbers.current {
...
#<?php echo $widget_id; ?>_content.wptp-pagination-style-14.wptp_widget_content .wptp-pagination li .fa { display: none; }
#<?php echo $widget_id; ?>_content.wptp-pagination-style-14.wptp_widget_content .wptp-pagination li { margin-right: 3px }
</style>
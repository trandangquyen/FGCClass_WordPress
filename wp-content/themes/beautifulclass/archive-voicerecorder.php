    ...
    <section class="content-area" style="transform: none; min-height: 256px;">
        <div class="top_site_main">
            ...
            <div class="page-title-wrapper">
                <div class="banner-wrapper container"><h1>Danh sách bài đọc</h1></div>
            </div>
        </div>
        ...
        <div id="voice-recorder" class="container site-content sidebar-right" style="transform: none;">
                    ...
                    <div id="lp-archive-courses">
                        <div class="thim-course-top switch-layout-container">
                            ...
                            <div class="course-index">
                                    <span>
                                        <?php
                                        $count_posts = wp_count_posts('voicerecorder');
                                        if ( $count_posts ) {

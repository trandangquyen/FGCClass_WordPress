                                ...
                                <div class="wrapper-box-icon has_custom_image has_read_more text-left overlay " data-text-readmore="#ffb606">
                                    <div class="smicon-box iconbox-left">
                                        ...
                                        <div class="content-inner" style="width: calc( 100% - 132px - 15px);">
                                            <div class="sc-heading article_heading">
                                                <h3 class="heading__primary">Các lớp học Online</h3></div><a class="smicon-read sc-btn" target="_self" href="<?php echo get_site_url() . '/cac-lop-hoc-tieng-anh/'; ?>" style="color: #ffb606;">View More<i class="fa fa-chevron-right"></i></a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="text-left color-white" id="coming-soon-counter5943e22bdb398">
                                    <div class="counter-group" id="myCounter">
                                        <div class="counter-block">
                                            <div id="countdown-days" class="counter days"></div>
                                            <div class="counter-caption">ngày</div>
                                        </div>
                                        <div class="counter-block">
                                            <div id="countdown-hours" class="counter hours"></div>
                                            <div class="counter-caption">giờ</div>
                                        </div>
                                        <div class="counter-block">
                                            <div id="countdown-minutes" class="counter minutes"></div>
                                            <div class="counter-caption">phút</div>
                                        </div>
                                        <div class="counter-block">
                                            <div id="countdown-seconds" class="counter seconds"></div>

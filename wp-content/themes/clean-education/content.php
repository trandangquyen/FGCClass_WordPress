...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="archive-post-wrap">
		<?php
		/**
		 * clean_education_before_entry_container hook
		 *
		 * @hooked clean_education_archive_content_image - 10
		 */
		do_action( 'clean_education_before_entry_container' ); ?>

		<div class="entry-container">
			<header class="entry-header">
				<?php if ( is_sticky() && is_home() && ! is_paged() ) : ?>
					<span class="sticky-post"><?php esc_html_e( 'Featured', 'clean-education' ); ?></span>
				<?php endif; ?>

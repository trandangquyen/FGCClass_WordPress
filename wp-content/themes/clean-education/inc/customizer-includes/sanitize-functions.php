 ...
 * @since Clean Education 0.1
 */
function clean_education_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 * @since Clean Education 0.1
 */
function clean_education_sanitize_custom_css( $input ) {
	if ( '' != $input  ) {
 ...
 */
function clean_education_sanitize_image( $image, $setting ) {
	/*
 ...
 * @since Clean Education 0.1
 */
function clean_education_sanitize_page( $input ) {
 ...
 * @since Clean Education 0.1
 */
function clean_education_sanitize_category_list( $input, $setting ) {
	// Get list of choices from the control associated with the setting.
	$taxonomy = $setting->manager->get_control( $setting->id )->taxonomy;
 ...
 *                    the setting default.
 */
function clean_education_sanitize_number_range( $number, $setting ) {
 ...
 * @since Clean Education 0.1
 */
function clean_education_sanitize_footer_code( $input ) {
 ...
 */
function clean_education_sanitize_select( $input, $setting ) {
	// Get list of choices from the control associated with the setting.
 ...
 * @since Clean Education 0.1
 */
function clean_education_sanitize_important_link() {
	return false;
}
 ...
 */
( function( api ) {
    wp.customize( 'clean_education_theme_options[reset_all_settings]', function( setting ) {
        setting.bind( function( value ) {
            ...
            if ( value ) {
                setting.notifications.add( code, new wp.customize.Notification(
                    ...
                    {
                        type: 'info',
                        message: clean_education_data.reset_message
                    }
                ) );
            } else {
    ...
    api.controlConstructor.radio = api.Control.extend( {
        ready: function() {
            if ( 'clean_education_theme_options[color_scheme]' === this.id ) {
                this.setting.bind( 'change', function( color_scheme ) {
                    jQuery.each( clean_education_data.clean_education_color_list, function( index, value ) {
